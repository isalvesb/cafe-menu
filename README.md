...
O Café Menu foi um dos meus primeiros projetos durante meus estudos de **HTML** e **CSS** pelo FreeCodeCamp  
O objetivo era praticar:

- Estruturação com HTML
- Estilização básica com CSS
- Layout simples e harmônico
- Espaçamento, fontes e organização visual
...
- Adicionar transições/efeitos
- Criar versão dark/light
- Criar mais páginas
